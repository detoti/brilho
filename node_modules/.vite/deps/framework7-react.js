...
} from "./chunk-A2GUDRSX.js";
import {
  require_react
} from "./chunk-YSDLPTTY.js";
import "./chunk-2SPOWFPE.js";
import "./chunk-OUNVTANF.js";
import "./chunk-XFNZVQ4Z.js";
import "./chunk-CMOS4D7O.js";
import "./chunk-JWL65P4K.js";
import "./chunk-GBDLSSFZ.js";
import "./chunk-GWMKRGKK.js";
import "./chunk-UUGCU45C.js";
...
var Sheet = (0, import_react8.forwardRef)((props, ref) => {
  ...
  const onMount = () => {
    ...
    if ("breakpoints" in props)
      sheetParams.breakpoints = breakpoints;
    if ("backdropBreakpoint" in props)
      sheetParams.backdropBreakpoint = backdropBreakpoint;
    if ("pushBreakpoint" in props)
      sheetParams.pushBreakpoint = pushBreakpoint;
    f7ready(() => {
...
var Popover = (0, import_react9.forwardRef)((props, ref) => {
  ...
  return import_react9.default.createElement("div", _extends5({
    ...
    className: classes,
    ref: elRef
  }, extraAttrs), arrow !== false && import_react9.default.createElement("div", {
...
var AreaChart = (0, import_react23.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const [currentIndex, setCurrentIndex] = (0, import_react23.useState)(null);
  const previousIndex = (0, import_react23.useRef)(null);
  const [hiddenDatasets, setHiddenDatasets] = (0, import_react23.useState)([]);
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react23.useRef)(null);
  const svgElRef = (0, import_react23.useRef)(null);
  const f7Tooltip = (0, import_react23.useRef)(null);
  const linesOffsets = (0, import_react23.useRef)(null);
  ...
  return import_react23.default.createElement("div", _extends17({
    ...
    className: classes,
    ref: elRef
  }, extraAttrs), import_react23.default.createElement("svg", {
    ...
    ref: svgElRef
  }, chartData.map((data, index) => import_react23.default.createElement(ChartTag, {
    key: `${ChartTag}-${index}`,
  ...
  })), verticalLines.map((line, index) => import_react23.default.createElement("line", {
    key: `line-${index}`,
    "data-index": index,
    fill: "#000",
    x1: line,
  ...
  }))), axis && import_react23.default.createElement("div", {
    className: "area-chart-axis"
  }, axisLabels.map((label, index) => import_react23.default.createElement("span", {
    key: index
  }, visibleLegends.includes(label) && import_react23.default.createElement("span", null, formatAxisLabel(label))))), legend && import_react23.default.createElement("div", {
    className: "area-chart-legend"
  }, datasets.map((dataset, index) => import_react23.default.createElement(LegendItemTag, {
    key: index,
...
var Badge = (0, import_react25.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react25.default.createElement("span", _extends18({
    id,
    style,
    className: classes,
    ref: elRef
...
var BlockFooter = (0, import_react26.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react26.default.createElement("div", _extends19({
    id,
    style,
    className: classes,
    ref: elRef
...
var BlockHeader = (0, import_react27.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var BlockTitle = (0, import_react28.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var Block = (0, import_react29.forwardRef)((props, ref) => {
  const {
    className,
    inset,
    insetIos,
...
var BreadcrumbsCollapsed = (0, import_react30.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react30.default.createElement("div", _extends23({
    ...
    style,
    onClick
  }, extraAttrs), import_react30.default.createElement("span", null), children);
});
...
var BreadcrumbsItem = (0, import_react31.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var BreadcrumbsSeparator = (0, import_react32.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style
...
var Breadcrumbs = (0, import_react33.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var useTheme = () => {
  const [t, setTheme2] = (0, import_react34.useState)(f7 ? theme : null);
  if (!f7) {
    f7ready(() => {
      setTheme2(theme);
    });
...
var Icon = (0, import_react35.forwardRef)((props, ref) => {
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react35.useRef)(null);
  ...
  return import_react35.default.createElement("i", _extends27({
    id,
    style: extend({
...
var useIcon = function(props) {
  ...
  if (icon || iconMaterial || iconF7 || iconMd || iconIos) {
    return import_react36.default.createElement(icon_default, {
      ...
      color: iconColor,
      size: iconSize
    }, (iconBadge || iconBadge === 0) && import_react36.default.createElement(badge_default, {
...
var Preloader = (0, import_react38.forwardRef)((props, ref) => {
  const theme2 = useTheme();
  const {
    className,
    id,
  ...
  let innerEl;
  if (theme2 && theme2.md) {
    innerEl = import_react38.default.createElement("span", {
      className: "preloader-inner"
    }, import_react38.default.createElement("svg", {
      viewBox: "0 0 36 36"
    }, import_react38.default.createElement("circle", {
      cx: "18",
      cy: "18",
      r: "16"
    })));
  ...
  return import_react38.default.createElement("span", _extends28({
    id,
...
var Button = (0, import_react39.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  let textEl;
  if (text) {
    textEl = import_react39.default.createElement("span", null, text);
  }
  if (preloader) {
    return import_react39.default.createElement(ButtonTag, _extends29({
      ref: elRef,
      id,
      style,
      className: getClasses()
      ...
      onClick
    }), import_react39.default.createElement(preloader_default, {
      size: preloaderSize,
      color: preloaderColor
    }), import_react39.default.createElement("span", null, iconEl, textEl, children));
  }
  return import_react39.default.createElement(ButtonTag, _extends29({
    ref: elRef,
    id,
...
var CardContent = (0, import_react40.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react40.default.createElement("div", _extends30({
    id,
    style,
    className: classes,
    ref: elRef
...
var CardFooter = (0, import_react41.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var CardHeader = (0, import_react42.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var Card = (0, import_react43.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  if (title || slots.header) {
    headerEl = import_react43.default.createElement(card_header_default, null, title, slots.header);
  }
  if (content || slots.content) {
    contentEl = import_react43.default.createElement(card_content_default, {
      padding
    }, content, slots.content);
  }
  if (footer || slots.footer) {
    footerEl = import_react43.default.createElement(card_footer_default, null, footer, slots.footer);
  }
...
var Checkbox = (0, import_react44.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const inputElRef = (0, import_react44.useRef)(null);
  ...
  const inputEl = import_react44.default.createElement("input", {
    ref: inputElRef,
    type: "checkbox",
    name: name2,
    value,
  ...
  const iconEl = import_react44.default.createElement("i", {
  ...
  return import_react44.default.createElement("label", _extends34({
    id,
    style,
    className: classes,
    ref: elRef
...
var Chip = (0, import_react45.forwardRef)((props, ref) => {
  ...
  if (media || iconEl || slots && slots.media) {
    ...
    mediaEl = import_react45.default.createElement("div", {
      className: mediaClasses
    }, iconEl, media, slots.media);
  }
  if (text || slots && (slots.text || slots.default && slots.default.length)) {
    labelEl = import_react45.default.createElement("div", {
      className: "chip-label"
    }, text, slots.text, slots.default);
  }
  if (deleteable) {
    deleteEl = import_react45.default.createElement("a", {
  ...
  return import_react45.default.createElement("div", _extends35({
    id,
    style,
    className: classes,
    ref: elRef
...
var FabBackdrop = (0, import_react46.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var FabButton = (0, import_react47.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  let labelEl;
  if (label) {
    labelEl = import_react47.default.createElement("span", {
      className: "fab-label"
    }, label);
  }
  return import_react47.default.createElement("a", _extends37({
    id,
    style,
    target,
    className: classes,
...
var FabButtons = (0, import_react48.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var Fab = (0, import_react49.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  if (text || textSlots && textSlots.length) {
    textEl = import_react49.default.createElement("div", {
      className: "fab-text"
    }, text, textSlots);
  }
  let linkEl;
  if (linkChildren.length || linkSlots && linkSlots.length || textEl) {
    linkEl = import_react49.default.createElement("a", {
      target,
      href: hrefComputed,
      onClick
...
var Gauge = (0, import_react50.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react50.default.createElement("div", _extends40({
    ...
    className: classes,
    ref: elRef
  }, extraAttrs), import_react50.default.createElement("svg", {
    className: "gauge-svg",
    width: `${size}px`,
    height: `${semiCircle ? size / 2 : size}px`,
    viewBox: `0 0 ${size} ${semiCircle ? size / 2 : size}`
  }, semiCircle && import_react50.default.createElement("path", {
  ...
  }), !semiCircle && borderBgColor && import_react50.default.createElement("circle", {
    ...
    cy: size / 2,
    r: radius
  }), !semiCircle && import_react50.default.createElement("circle", {
    ...
    cy: size / 2,
    r: radius
  }), valueText && import_react50.default.createElement("text", {
  ...
  }, valueText), labelText && import_react50.default.createElement("text", {
...
var Toggle = (0, import_react51.forwardRef)((props, ref) => {
  const f7Toggle = (0, import_react51.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  const inputElRef = (0, import_react51.useRef)(null);
  const onChange = (event) => {
    emit(props, "change", event);
  };
  ...
  const inputEl = import_react51.default.createElement("input", {
    ref: inputElRef,
    type: "checkbox",
    name: name2,
    disabled,
  ...
  return import_react51.default.createElement("label", _extends41({
    id,
    style,
    className: labelClasses,
    ref: elRef
  }, extraAttrs), inputEl, import_react51.default.createElement("span", {
...
var Range = (0, import_react52.forwardRef)((props, ref) => {
  const f7Range = (0, import_react52.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  return import_react52.default.createElement("div", _extends42({
    ...
    style,
    className: classes
  }, extraAttrs), input && import_react52.default.createElement("input", {
    type: "range",
    name: name2,
    id: inputId
  }), children);
...
var TextEditor = (0, import_react53.forwardRef)((props, ref) => {
  const f7TextEditor = (0, import_react53.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  return import_react53.default.createElement("div", _extends43({
    ref: elRef,
    id,
    style,
    className: classes
  }, extraAttrs), slots["root-start"], import_react53.default.createElement("div", {
...
var Input = (0, import_react54.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const [inputInvalid, setInputInvalid] = (0, import_react54.useState)(false);
  const [inputFocused, setInputFocused] = (0, import_react54.useState)(false);
  const extraAttrs = getExtraAttrs(props);
  const f7Calendar = (0, import_react54.useRef)(null);
  const f7ColorPicker = (0, import_react54.useRef)(null);
  const elRef = (0, import_react54.useRef)(null);
  const inputElRef = (0, import_react54.useRef)(null);
  const updateInputOnDidUpdate = (0, import_react54.useRef)(false);
  const getDomValue = () => {
    if (!inputElRef.current)
      return void 0;
  ...
  const createInput = (InputTag, children) => {
    ...
    return import_react54.default.createElement(InputTag, _extends44({
      ref: inputElRef,
      style: inputStyle,
      name: name2,
  ...
  if (type === "select" || type === "textarea" || type === "file") {
    ...
    inputEl = import_react54.default.createElement(toggle_default, {
      checked,
      readonly,
      name: name2,
      value,
    ...
    inputEl = import_react54.default.createElement(range_default, {
      value,
      disabled,
      min,
      max,
    ...
    inputEl = import_react54.default.createElement(text_editor_default, _extends44({
      value,
      resizable,
      placeholder,
  ...
  if (wrap) {
    ...
    return import_react54.default.createElement("div", _extends44({
      ...
      style,
      ref: elRef
    }, extraAttrs), inputEl, (errorMessage || slots["error-message"] && slots["error-message"].length) && errorMessageForce && import_react54.default.createElement("div", {
      className: "input-error-message"
    }, errorMessage, slots["error-message"]), clearButton && import_react54.default.createElement("span", {
      className: "input-clear-button"
    }), (info || slots.info && slots.info.length) && import_react54.default.createElement("div", {
...
var TabbarContext = import_react55.default.createContext({
...
var Link = (0, import_react57.forwardRef)((props, ref) => {
  const f7SmartSelect = (0, import_react57.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  const tabbarContext = (0, import_react57.useContext)(TabbarContext);
  ...
  if (text) {
    if (badge)
      badgeEl = import_react57.default.createElement(badge_default, {
        color: badgeColor
      }, badge);
    textEl = import_react57.default.createElement("span", {
  ...
  return import_react57.default.createElement("a", _extends45({
    ref: elRef,
    id,
    style,
    className: classes
...
var ListButton = (0, import_react58.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react58.useRef)(null);
  const linkElRef = (0, import_react58.useRef)(null);
  const onClick = (e) => {
    emit(props, "click", e);
  };
  ...
  return import_react58.default.createElement("li", _extends46({
    id,
    style,
    className,
    ref: elRef
  }, extraAttrs), import_react58.default.createElement("a", _extends46({
...
var ListContext = import_react59.default.createContext({
  listIsMedia: false,
  listIsSimple: false,
...
var ListGroup = (0, import_react60.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const listContext = (0, import_react60.useContext)(ListContext);
  ...
  return import_react60.default.createElement("div", _extends47({
    id,
    style,
    className: classes,
    "data-sortable-move-elements": typeof sortableMoveElements !== "undefined" ? sortableMoveElements.toString() : void 0,
    ref: elRef
  }, extraAttrs), import_react60.default.createElement("ul", null, import_react60.default.createElement(ListContext.Provider, {
    value: {
...
var ListIndex = (0, import_react61.forwardRef)((props, ref) => {
  const f7ListIndex = (0, import_react61.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  return import_react61.default.createElement("div", _extends48({
    id,
    style,
    className: classes,
    ref: elRef
...
var ListInput = (0, import_react62.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const [inputInvalid, setInputInvalid] = (0, import_react62.useState)(false);
  const [inputFocused, setInputFocused] = (0, import_react62.useState)(false);
  const listContext = (0, import_react62.useContext)(ListContext);
  const {
    listIsSortable = false
  } = listContext || {};
  const extraAttrs = getExtraAttrs(props);
  const f7Calendar = (0, import_react62.useRef)(null);
  const f7ColorPicker = (0, import_react62.useRef)(null);
  const elRef = (0, import_react62.useRef)(null);
  const inputElRef = (0, import_react62.useRef)(null);
  const itemContentElRef = (0, import_react62.useRef)(null);
  const updateInputOnDidUpdate = (0, import_react62.useRef)(false);
  const getDomValue = () => {
    if (!inputElRef.current)
      return void 0;
    return inputElRef.current.value;
  ...
  const createInput = (InputTag, children) => {
    ...
    return import_react62.default.createElement(InputTag, _extends49({
      ref: inputElRef,
      style: inputStyle,
      name: name2,
      type: needsType ? inputType : void 0,
  ...
  if (renderInput) {
    if (type === "select" || type === "textarea" || type === "file") {
      ...
      inputEl = import_react62.default.createElement(text_editor_default, _extends49({
        value,
        resizable,
        placeholder,
        onTextEditorFocus: onFocus,
  ...
  const ItemContent = import_react62.default.createElement("div", {
  ...
  }, slots["content-start"], (media || slots.media) && import_react62.default.createElement("div", {
    className: "item-media"
  }, media && import_react62.default.createElement("img", {
    src: media
  }), slots.media), import_react62.default.createElement("div", {
    className: "item-inner"
  }, slots["inner-start"], (label || slots.label) && import_react62.default.createElement("div", {
    className: classNames("item-title item-label", {
      "item-floating-label": floatingLabel
    })
  }, label, slots.label), import_react62.default.createElement("div", {
    className: classNames("item-input-wrap", {
      "input-dropdown": dropdown === "auto" ? type === "select" : dropdown
    })
  }, inputEl, slots.input, hasErrorMessage && errorMessageForce && import_react62.default.createElement("div", {
    className: "item-input-error-message"
  }, errorMessage, slots["error-message"]), clearButton && import_react62.default.createElement("span", {
    className: "input-clear-button"
  }), (info || slots.info) && import_react62.default.createElement("div", {
    className: "item-input-info"
  }, info, slots.info)), slots.inner, slots["inner-end"]), slots.content, slots["content-end"]);
  if (!wrap) {
    return ItemContent;
  }
  return import_react62.default.createElement("li", _extends49({
    ref: elRef,
    id,
    style,
  ...
  }, extraAttrs), slots["root-start"], ItemContent, isSortableComputed && import_react62.default.createElement("div", {
...
var ListItemContent = (props) => {
  ...
  const inputElRef = (0, import_react63.useRef)(null);
  ...
  let footerEl;
  if (radio || checkbox) {
    inputEl = import_react63.default.createElement("input", {
      ref: inputElRef,
      value,
      name: name2,
      checked,
    ...
    inputIconEl = import_react63.default.createElement("i", {
  ...
  if (media || slots.media) {
    let mediaImgEl;
    if (media) {
      mediaImgEl = import_react63.default.createElement("img", {
        src: media
      });
    }
    mediaEl = import_react63.default.createElement("div", {
      className: "item-media"
    }, mediaImgEl, slots.media);
  }
  if (header || slots.header) {
    headerEl = import_react63.default.createElement("div", {
      className: "item-header"
    }, header, slots.header);
  }
  if (footer || slots.footer) {
    footerEl = import_react63.default.createElement("div", {
      className: "item-footer"
    }, footer, slots.footer);
  }
  if (title || slots.title || !isMediaComputed && headerEl || !isMediaComputed && footerEl) {
    titleEl = import_react63.default.createElement("div", {
      className: "item-title"
    }, !isMediaComputed && headerEl, title, slots.title, !isMediaComputed && footerEl);
  }
  if (subtitle || slots.subtitle) {
    subtitleEl = import_react63.default.createElement("div", {
      className: "item-subtitle"
    }, subtitle, slots.subtitle);
  }
  if (text || slots.text) {
    textEl = import_react63.default.createElement("div", {
      className: "item-text"
    }, text, slots.text);
  }
  if (after || badge || slots.after) {
    if (after) {
      afterEl = import_react63.default.createElement("span", null, after);
    }
    if (badge) {
      badgeEl = import_react63.default.createElement(badge_default, {
        color: badgeColor
      }, badge);
    }
    afterWrapEl = import_react63.default.createElement("div", {
      className: "item-after"
    }, slots["after-start"], afterEl, badgeEl, slots.after, slots["after-end"]);
  }
  if (isMediaComputed) {
    titleRowEl = import_react63.default.createElement("div", {
      className: "item-title-row"
    }, slots["before-title"], titleEl, slots["after-title"], afterWrapEl);
    innerEl = import_react63.default.createElement("div", {
      className: "item-inner"
  ...
  return import_react63.default.createElement(ItemContentTag, {
    className: classes,
    onClick
  }, isSortableComputed && sortable !== false && isSortableOppositeComputed && import_react63.default.createElement("div", {
    className: "sortable-handler"
...
var ListItem = (0, import_react64.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const linkElRef = (0, import_react64.useRef)(null);
  const f7SmartSelect = (0, import_react64.useRef)(null);
  const onClick = (event) => {
  ...
  if (!listIsSimple) {
    itemContentEl = import_react64.default.createElement(list_item_content_default, _extends50({}, props, {
      slots,
      onChange,
    ...
    if (link || href || accordionItem || smartSelect) {
      ...
      linkEl = import_react64.default.createElement("a", _extends50({
        ref: linkElRef,
        className: linkClasses
      }, linkAttrs, {
        onClick
  ...
  if (groupTitle) {
    return import_react64.default.createElement("li", {
      ref: elRef,
      id,
      style,
      className: liClasses,
      ...
      onClick
    }, import_react64.default.createElement("span", null, title, children));
  }
  if (listIsSimple) {
    return import_react64.default.createElement("li", {
      ref: elRef,
  ...
  return import_react64.default.createElement("li", _extends50({
    ref: elRef,
    id,
    style,
    className: liClasses,
    "data-virtual-list-index": virtualListIndex
  }, extraAttrs), slots["root-start"], swipeout ? import_react64.default.createElement("div", {
    className: "swipeout-content"
  }, linkItemEl) : linkItemEl, isSortableComputed && sortable !== false && !isSortableOppositeComputed && import_react64.default.createElement("div", {
    className: "sortable-handler"
...
var List = (0, import_react65.forwardRef)((props, ref) => {
  const f7VirtualList = (0, import_react65.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  return import_react65.default.createElement(ListTag, _extends51({
    id,
    ref: elRef,
    style,
    className: classes
    ...
    "data-sortable-move-elements": typeof sortableMoveElements !== "undefined" ? sortableMoveElements.toString() : void 0,
    onSubmit
  }), import_react65.default.createElement(ListContext.Provider, {
    value: {
  ...
  }, slots["before-list"], rootChildrenBeforeList, ulChildren.length > 0 && import_react65.default.createElement("ul", null, ulChildren), slots["after-list"], rootChildrenAfterList));
});
...
var LoginScreenTitle = (0, import_react66.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react66.default.createElement("div", _extends52({
    id,
    style,
    className: classes,
    ref: elRef
...
var Message = (0, import_react67.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react67.default.createElement("div", _extends53({
    ...
    onClick
  }), slots.start, (avatar || slots.avatar) && import_react67.default.createElement("div", {
    className: "message-avatar",
    style: {
      backgroundImage: avatar && `url(${avatar})`
    },
    onClick: onAvatarClick
  }, slots.avatar), import_react67.default.createElement("div", {
    className: "message-content"
  }, slots["content-start"], (slots.name || name2) && import_react67.default.createElement("div", {
    className: "message-name",
    onClick: onNameClick
  }, name2, slots.name), (slots.header || header) && import_react67.default.createElement("div", {
    className: "message-header",
    onClick: onHeaderClick
  }, header, slots.header), import_react67.default.createElement("div", {
    className: "message-bubble",
    onClick: onBubbleClick
  }, slots["bubble-start"], (slots.image || image) && import_react67.default.createElement("div", {
    className: "message-image"
  }, slots.image || import_react67.default.createElement("img", {
    src: image
  })), (slots["text-header"] || textHeader) && import_react67.default.createElement("div", {
    className: "message-text-header"
  }, textHeader, slots["text-header"]), (slots.text || text || typing) && import_react67.default.createElement("div", {
    className: "message-text",
    onClick: onTextClick
  }, text, slots.text, typing && import_react67.default.createElement("div", {
    className: "message-typing-indicator"
  }, import_react67.default.createElement("div", null), import_react67.default.createElement("div", null), import_react67.default.createElement("div", null))), (slots["text-footer"] || textFooter) && import_react67.default.createElement("div", {
    className: "message-text-footer"
  }, textFooter, slots["text-footer"]), slots["bubble-end"], slots.default), (slots.footer || footer) && import_react67.default.createElement("div", {
...
var MessagebarAttachment = (0, import_react68.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react68.default.createElement("div", _extends54({
    id,
    style,
    className: classes,
    ref: elRef
    ...
    onClick
  }), image && import_react68.default.createElement("img", {
    src: image
  }), deletable && import_react68.default.createElement("span", {
...
var MessagebarAttachments = (0, import_react69.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react69.default.createElement("div", _extends55({
    id,
    style,
    className: classes,
    ref: elRef
...
var MessagebarSheetImage = (0, import_react70.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react70.default.createElement("label", _extends56({
    id,
    className: classes,
    style: styles,
    ref: elRef
  }, extraAttrs), import_react70.default.createElement("input", {
    type: "checkbox",
    checked,
    onChange
  }), import_react70.default.createElement("i", {
    className: "icon icon-checkbox"
  }), image && import_react70.default.createElement("img", {
    src: image
  }), children);
});
...
var MessagebarSheetItem = (0, import_react71.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react71.default.createElement("div", _extends57({
    id,
    style,
    className: classes,
    ref: elRef
...
var MessagebarSheet = (0, import_react72.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var Messagebar = (0, import_react73.forwardRef)((props, ref) => {
  const f7Messagebar = (0, import_react73.useRef)(null);
  const updateSheetVisible = (0, import_react73.useRef)(false);
  const updateAttachmentsVisible = (0, import_react73.useRef)(false);
  const {
    className,
    id,
    style,
  ...
  const areaElRef = (0, import_react73.useRef)(null);
  const onChange = (event) => {
    emit(props, "change", event);
  };
  const onInput = (event) => {
  ...
  return import_react73.default.createElement("div", _extends59({
    id,
    style,
    className: classes,
    ref: elRef
  }, extraAttrs), slotsBeforeInner, import_react73.default.createElement("div", {
    className: "toolbar-inner"
  }, slotsInnerStart, import_react73.default.createElement("div", {
    className: "messagebar-area"
  }, slotsBeforeArea, messagebarAttachmentsEl, import_react73.default.createElement(input_default, _extends59({
    inputId: textareaId,
    ref: areaElRef,
    type: "textarea",
    wrap: false,
    ...
    onFocus,
    onBlur
  }, valueProps)), slotsAfterArea), (sendLink && sendLink.length > 0 || slotsSendLink) && import_react73.default.createElement(link_default, {
    onClick
...
var MessagesTitle = (0, import_react74.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var Messages = (0, import_react75.forwardRef)((props, ref) => {
  const f7Messages = (0, import_react75.useRef)(null);
  const mounted = (0, import_react75.useRef)(false);
  const {
    className,
    id,
    style,
  ...
  const childrenBeforeUpdated = (0, import_react75.useRef)(null);
  const reactChildrenBefore = (0, import_react75.useRef)(children ? import_react75.default.Children.count(children) : 0);
  ...
  const currentChildrenLength = children ? import_react75.default.Children.count(children) : 0;
...
var NavLeft = (0, import_react76.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  if (backLink) {
    ...
    linkEl = import_react76.default.createElement(link_default, {
      href: backLinkUrl || "#",
      back: true,
      icon: "icon-back",
...
var NavRight = (0, import_react77.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
...
var NavTitleLarge = (0, import_react78.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react78.default.createElement("div", _extends64({
    id,
    style,
    className: classes,
    ref: elRef
  }, extraAttrs), import_react78.default.createElement("div", {
...
var NavTitle = (0, import_react79.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  let subtitleEl;
  if (subtitle) {
    subtitleEl = import_react79.default.createElement("span", {
      className: "subtitle"
    }, subtitle);
  }
...
var Navbar = (0, import_react80.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const routerPositionClass = (0, import_react80.useRef)("");
  const largeCollapsed = (0, import_react80.useRef)(false);
  const routerNavbarRole = (0, import_react80.useRef)(null);
  const routerNavbarRoleDetailRoot = (0, import_react80.useRef)(false);
  const routerNavbarMasterStack = (0, import_react80.useRef)(false);
  const transparentVisible = (0, import_react80.useRef)(false);
  const extraAttrs = getExtraAttrs(props);
  ...
  if (backLink || slots["nav-left"] || slots.left) {
    leftEl = import_react80.default.createElement(nav_left_default, {
      backLink,
      backLinkUrl,
      backLinkForce,
      backLinkShowText,
  ...
  if (title || subtitle || slots.title) {
    titleEl = import_react80.default.createElement(nav_title_default, {
      title,
      subtitle
    }, slots.title);
  }
  if (slots["nav-right"] || slots.right) {
    rightEl = import_react80.default.createElement(nav_right_default, null, slots["nav-right"], slots.right);
  }
  let largeTitle = titleLarge;
  if (!largeTitle && large && title)
    largeTitle = title;
  if (largeTitle || slots["title-large"]) {
    titleLargeEl = import_react80.default.createElement("div", {
      className: "title-large"
    }, import_react80.default.createElement("div", {
      className: "title-large-text"
    }, largeTitle || "", slots["title-large"]));
  }
  const innerEl = import_react80.default.createElement("div", {
  ...
  return import_react80.default.createElement("div", _extends66({
    ...
    className: classes,
    ref: elRef
  }, extraAttrs), import_react80.default.createElement("div", {
    className: "navbar-bg"
...
var PageContent = (0, import_react81.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  let infiniteEl;
  if (ptr && ptrPreloader) {
    ptrEl = import_react81.default.createElement("div", {
      className: "ptr-preloader"
    }, import_react81.default.createElement(preloader_default, null), import_react81.default.createElement("div", {
      className: "ptr-arrow"
    }));
  }
  if (infinite && infinitePreloader) {
    infiniteEl = import_react81.default.createElement(preloader_default, {
...
var Page = (0, import_react82.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const hasSubnavbar = (0, import_react82.useRef)(false);
  const hasNavbarLarge = (0, import_react82.useRef)(false);
  const hasNavbarLargeCollapsed = (0, import_react82.useRef)(false);
  const hasCardExpandableOpened = (0, import_react82.useRef)(false);
  const routerPositionClass = (0, import_react82.useRef)("");
  const routerPageRole = (0, import_react82.useRef)(null);
  const routerPageRoleDetailRoot = (0, import_react82.useRef)(false);
  const routerPageMasterStack = (0, import_react82.useRef)(false);
  const extraAttrs = getExtraAttrs(props);
  ...
  const pageContentEl = import_react82.default.createElement(page_content_default, {
    ptr,
    ptrDistance,
    ptrPreloader,
    ptrBottom,
...
var PhotoBrowser = (0, import_react83.forwardRef)((props, ref) => {
  const f7PhotoBrowser = (0, import_react83.useRef)(null);
  const {
    init = true,
    params,
    photos,
...
var PieChart = (0, import_react84.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const [currentIndex, setCurrentIndex] = (0, import_react84.useState)(null);
  const previousIndex = (0, import_react84.useRef)(null);
  const elRef = (0, import_react84.useRef)(null);
  const f7Tooltip = (0, import_react84.useRef)(null);
  ...
  return import_react84.default.createElement("div", _extends69({
    id,
    style,
    className: classes,
    ref: elRef
  }, extraAttrs), import_react84.default.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: size,
    height: size,
  ...
  }, paths.map((path, index) => import_react84.default.createElement("path", {
...
var Progressbar = (0, import_react85.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react85.default.createElement("span", _extends70({
    ref: elRef,
    id,
    style,
    className: classes,
    "data-progress": progress
  }, extraAttrs), import_react85.default.createElement("span", {
...
var Radio = (0, import_react86.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const inputEl = import_react86.default.createElement("input", {
    type: "radio",
    name,
    value,
    disabled,
  ...
  const iconEl = import_react86.default.createElement("i", {
    className: "icon-radio"
  });
  const classes = classNames(className, "radio", {
    disabled
  }, colorClasses(props));
  return import_react86.default.createElement("label", _extends71({
    id,
    style,
    className: classes,
    ref: elRef
...
var Searchbar = (0, import_react87.forwardRef)((props, ref) => {
  const f7Searchbar = (0, import_react87.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  const slots = getSlots(props);
  return import_react87.default.createElement(SearchbarTag, _extends72({
    ref: elRef,
    id,
    style,
    className: classes
...
var Segmented = (0, import_react88.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react88.default.createElement(SegmentedTag, _extends73({
    id,
    style,
    className: classes,
    ref: elRef
  }, extraAttrs), children, (strong || strongIos || strongMd) && import_react88.default.createElement("span", {
...
var SkeletonBlock = ({
  ...
  return import_react89.default.createElement(Tag, _extends74({
    style: skeletonStyle,
...
var SkeletonText = ({
  ...
  return import_react90.default.createElement(Tag, _extends75({
    className: skeletonClassName
  }, other), children);
};
...
var SkeletonImage = ({
  ...
  return import_react91.default.createElement(Tag, _extends76({
    className: skeletonClassName
  }, other), import_react91.default.createElement("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width,
    height,
    viewBox: `0 0 ${width} ${height}`,
    ...
    preserveAspectRatio: "none"
  }, import_react91.default.createElement("polygon", {
    style: {
      fill: color
    },
    fillRule: "evenodd",
    points: `0 0 ${width} 0 ${width} ${height} 0 ${height}`
  }), showIcon && import_react91.default.createElement("path", {
    style: {
      fill: iconColor
    },
...
var SkeletonAvatar = ({
  ...
  return import_react92.default.createElement(Tag, _extends77({
    className: skeletonClassName
    ...
    preserveAspectRatio: "none"
  }, import_react92.default.createElement("rect", {
    width: size,
    height: size,
    fillRule: "evenodd",
    style: {
...
var Stepper = (0, import_react97.forwardRef)((props, ref) => {
  const f7Stepper = (0, import_react97.useRef)(null);
  const {
    className,
    id,
    style,
  ...
  if (input && !buttonsOnly) {
    const inputEl = import_react97.default.createElement("input", {
      name: name2,
      id: inputId,
      type: inputType,
    ...
    inputWrapEl = import_react97.default.createElement("div", {
      className: "stepper-input-wrap"
    }, inputEl);
  }
  if (!input && !buttonsOnly) {
    valueEl = import_react97.default.createElement("div", {
  ...
  return import_react97.default.createElement("div", _extends78({
    ref: elRef,
    id,
    style,
    className: classes
  }, extraAttrs), import_react97.default.createElement("div", {
    className: "stepper-button-minus",
    onClick: onMinusClick
  }), inputWrapEl, valueEl, import_react97.default.createElement("div", {
...
var Subnavbar = (0, import_react98.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react98.useRef)(null);
  ...
  return import_react98.default.createElement("div", _extends79({
    className: classes,
    id,
    style,
    ref: elRef
  }, extraAttrs), inner ? import_react98.default.createElement("div", {
    className: "subnavbar-inner"
  }, title && import_react98.default.createElement("div", {
...
var SwipeoutActions = (0, import_react99.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react99.useRef)(null);
  ...
  return import_react99.default.createElement("div", _extends80({
    id,
    style,
    className: classes,
    ref: elRef
...
var SwipeoutButton = (0, import_react100.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react100.useRef)(null);
  const onClick = (e) => {
    emit(props, "click", e);
  };
  (0, import_react100.useImperativeHandle)(ref, () => ({
    el: elRef.current
  }));
  const classes = classNames(className, {
  ...
  return import_react100.default.createElement("a", _extends81({
    ref: elRef,
    href: href || "#",
    id,
    style,
...
// node_modules/framework7-react/shared/tabs-swipeable-context.js
var import_react101 = __toESM(require_react(), 1);
var TabsSwipeableContext = import_react101.default.createContext(false);
...
var Tab = (0, import_react102.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react102.useRef)(null);
  const routerData = (0, import_react102.useRef)(null);
  const routerContext = (0, import_react102.useContext)(RouterContext);
  const tabsSwipeableContext = (0, import_react102.useContext)(TabsSwipeableContext);
  ...
  const [tabContent, setTabContent] = (0, import_react102.useState)(initialTabContent || null);
  ...
  const renderChildren = () => {
    ...
    return import_react102.default.createElement(TabContent, _extends82({
      key: tabContent.id
    }, tabContent.props));
  };
  ...
  return import_react102.default.createElement(Component, _extends82({
    id,
    style,
    ref: elRef
...
var Tabs = (0, import_react103.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react103.useRef)(null);
  ...
  if (animated) {
    return import_react103.default.createElement("div", _extends83({
      id,
      style,
      className: classNames("tabs-animated-wrap", classes),
      ref: elRef
    }, extraAttrs), import_react103.default.createElement("div", {
      className: tabsClasses
    }, children));
  }
  if (swipeable) {
    return import_react103.default.createElement("swiper-container", _extends83({
      id,
      style,
      class: classNames(tabsClasses, classes),
      ref: elRef,
      init: swiperParams ? "false" : "true"
    }, extraAttrs), import_react103.default.createElement(TabsSwipeableContext.Provider, {
      value: true
    }, children));
  }
  return import_react103.default.createElement("div", _extends83({
...
var Toolbar = (0, import_react104.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const slots = getSlots(props);
  return import_react104.default.createElement("div", _extends84({
    id,
    style,
    className: classes,
    ref: elRef
  }, extraAttrs), import_react104.default.createElement(TabbarContext.Provider, {
    value: {
      tabbarHasIcons: icons
    }
  }, slots["before-inner"], inner ? import_react104.default.createElement("div", {
    className: "toolbar-inner"
...
var TreeviewItem = (0, import_react105.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  const extraAttrs = getExtraAttrs(props);
  const elRef = (0, import_react105.useRef)(null);
  const onClick = (event) => {
    emit(props, "click", event);
  };
  const onOpen = (el) => {
  ...
  return import_react105.default.createElement("div", _extends85({
    id,
    style,
    className: classes,
    ref: elRef
  }, extraAttrs), import_react105.default.createElement(TreeviewRootTag, _extends85({
    onClick,
    className: itemRootClasses
  }, itemRootAttrs), slots["root-start"], needToggle && import_react105.default.createElement("div", {
    className: "treeview-toggle"
  }), import_react105.default.createElement("div", {
    className: "treeview-item-content"
  }, slots["content-start"], iconEl, slots.media, import_react105.default.createElement("div", {
    className: "treeview-item-label"
  }, slots["label-start"], label, slots.label), slots.content, slots["content-end"]), slots.root, slots["root-end"]), hasChildren && import_react105.default.createElement("div", {
...
var Treeview = (0, import_react106.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react106.default.createElement("div", _extends86({
    id,
    style,
    className: classes,
    ref: elRef
...
var Views = (0, import_react107.forwardRef)((props, ref) => {
  const {
    className,
    id,
    style,
  ...
  return import_react107.default.createElement("div", _extends87({
    id,
    style,
    className: classes,
    ref: elRef
