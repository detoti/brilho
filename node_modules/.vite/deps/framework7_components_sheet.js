...
var Sheet = class extends modal_class_default {
  constructor(app, params) {
    ...
    function handleTouchStart(e) {
      ...
      if (dom7_default(e.target).closest(".sortable-handler").length > 0)
        return;
      isTouched = true;
      isMoved = false;
      startTouch = {
    ...
    const setPushBreakpoint = (breakpoint) => {
      ...
      if (pushBreakpoint === null || typeof pushBreakpoint === "undefined" || !sheet.push || !pushOffset)
        return;
    ...
    const setBackdropBreakpoint = (breakpoint) => {
      ...
      if (!backdropBreakpoint || !backdrop || !$backdropEl.length)
        return;
    ...
    sheet.calcBreakpoints = () => {
      ...
      const isTopSheetModal2 = $el.hasClass("sheet-modal-top");
      breakpointsTranslate = [];
      sheet.params.breakpoints.forEach((ratio) => {
        breakpointsTranslate.push((fullSize - fullSize * ratio) * (isTopSheetModal2 ? -1 : 1));
      });
    };
    ...
    sheet.on("open", () => {
      ...
      if (sheet.push) {
        ...
        if (Number.isNaN(pushOffset))
          pushOffset = 0;
        if (!pushOffset)
          pushOffset = app.theme === "ios" ? 44 : 48;
...
//# sourceMappingURL=framework7_components_sheet.js.map
